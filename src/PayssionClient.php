...
class PayssionClient
{
    ...
    protected static $sig_keys = [
    		'payment/create' => ['api_key', 'pm_id', 'amount', 'currency', 'order_id', 'secret_key'],
    		'payment/details' => ['api_key', 'transaction_id', 'order_id', 'secret_key'],
    		'refunds' => ['api_key', 'transaction_id', 'amount', 'currency', 'secret_key']
    ];
     ...
     * @var array
     */
    protected $allowed_request_methods = ['get', 'put', 'post', 'delete'];
     ...
     */
    public function __construct($is_livemode = true)
    {
        $this->api_key = $is_livemode == true ? PAYSSION_API_KEY : PAYSSION_SANDBOX_API_KEY;
        $this->secret_key = $is_livemode == true ? PAYSSION_SECRET_KEY : PAYSSION_SANDBOX_SECRET_KEY;
        $validate_params = [
    ...
    {
        return $this->call('payment/create', 'post', $params);
    }
    ...
    {
    	return $this->call('payment/details', 'post', $params);
    }
    ...
    */
    ...
    {
    	return $this->call('refunds', 'post', $params);
    }
